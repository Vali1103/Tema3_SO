...
typedef struct os_threadpool {
	...
	pthread_t *threads;
	pthread_mutex_t queue_mutex; // Mutex pentru sincronizarea accesului in coada de task-uri
    pthread_barrier_t pool_barrier; // Bariera pentru sincronizare threadurilor in diferite puncte
	/*
